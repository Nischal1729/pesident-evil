...
import {
  AREAS, BUILDINGS, CAMPUS_BOUNDS, GLOBE_POS, INTERIOR_ZONES, MAIN_GATE_X, MRD_DRUM, NO_TREE_ZONES, ORR, ORR_NORMAL, orrPoint, PATHS, PLAZA_TERRACE, QUAD, ROADS, WALLS,
